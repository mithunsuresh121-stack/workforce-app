...
messages_sent_total = Counter(
    "workforce_messages_sent_total", "Total messages sent", registry=registry
)
meetings_joined_total = Counter(
    "workforce_meetings_joined_total", "Total meetings joined", registry=registry
)
