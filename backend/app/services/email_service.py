...
class EmailService:
    ...
    def _send_via_smtp(
        ...
        try:
            ...
            logger.warning(
                "SMTP failed, trying SendGrid fallback", error=str(e), to_email=to_email
            )
            return False
    ...
    def _send_via_sendgrid(
        ...
        try:
            ...
            if template_id and dynamic_data:
                ...
                logger.info(
                    "Sending email via SendGrid with dynamic template",
                    to_email=to_email,
                ...
                logger.info(
                    "Sending email via SendGrid with basic content",
                    to_email=to_email,
                    subject=subject,
                )
            ...
            logger.warning(
                "SendGrid library not installed, skipping API fallback",
                to_email=to_email,
            )
            return False
        except Exception as e:
    ...
    def send_welcome_email(
        self, to_email: str, user_name: str, company_name: str = "Your Company"
    ) -> bool:
    ...
    def send_password_reset_email(
        ...
        dynamic_data = {"username": user_name, "reset_link": reset_url}
        logger.info(
        ...
        return self._send_via_sendgrid(
            to_email, "", "", template_id=template_id, dynamic_data=dynamic_data
        )

    def send_notification_email(
        self, to_email: str, title: str, message: str, user_name: str = "User"
    ) -> bool:
