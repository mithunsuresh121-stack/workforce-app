...
AUTH_TOKEN = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkZW1vQGNvbXBhbnkuY29tIiwicm9sZSI6Im1hbmFnZXIiLCJjb21wYW55X2lkIjo0LCJleHAiOjE3MzU5MzE2MDB9.example_token"
...
def main():
    ...
    endpoint_test(
        ...
        expected_status=422,
        description="POST /shifts/ - Invalid shift data"
    )
