...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "REJECTED", "CANCELLED", name="swapstatus"),
            nullable=False,
        ),
    ...
    op.alter_column(
        "announcements", "created_by", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "documents", "company_id", existing_type=sa.INTEGER(), nullable=False
    )
    ...
    op.create_foreign_key(
        None, "notification_preferences", "users", ["user_id"], ["id"]
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "documents", "company_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "announcements", "created_by", existing_type=sa.INTEGER(), nullable=True
    )
