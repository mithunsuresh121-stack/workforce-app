...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("DIRECT", "GROUP", "PUBLIC", name="channeltype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ORGANIZER", "PARTICIPANT", name="participantrole"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_message_reactions_id"), "message_reactions", ["id"], unique=False
    )
