...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum(
                "ANNUAL", "SICK", "MATERNITY", "PATERNITY", "PERSONAL", name="leavetype"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("Approved", "Pending", "Rejected", name="leavestatus"),
            nullable=True,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "last_active", sa.DateTime(), server_default=sa.text("now()"), nullable=True
        ),
        sa.Column(
            "created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("POLICY", "PAYSLIP", "NOTICE", "OTHER", name="documenttype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_profile_update_requests_id"),
        "profile_update_requests",
        ["id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "SCHEDULED", "COMPLETED", "CANCELLED", "ON_LEAVE", name="shiftstatus"
            ),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "IN_PROGRESS", "COMPLETED", "OVERDUE", name="taskstatus"
            ),
