...
def upgrade() -> None:
    ...
    op.add_column('channels', sa.Column('last_message_at', sa.DateTime(), nullable=True))
    ...
    op.create_foreign_key('channels_company_id_fkey', 'channels', 'companies', ['company_id'], ['id'], ondelete='CASCADE')

    op.drop_constraint('channels_created_by_fkey', 'channels', type_='foreignkey')
    op.create_foreign_key('channels_created_by_fkey', 'channels', 'users', ['created_by'], ['id'], ondelete='CASCADE')
    ...
    op.drop_constraint('chat_messages_company_id_fkey', 'chat_messages', type_='foreignkey')
    op.create_foreign_key('chat_messages_company_id_fkey', 'chat_messages', 'companies', ['company_id'], ['id'], ondelete='CASCADE')
    ...
    op.drop_constraint('chat_messages_channel_id_fkey', 'chat_messages', type_='foreignkey')
    op.create_foreign_key('chat_messages_channel_id_fkey', 'chat_messages', 'channels', ['channel_id'], ['id'], ondelete='CASCADE')

    # Message reactions table FKs
    op.drop_constraint('message_reactions_message_id_fkey', 'message_reactions', type_='foreignkey')
    op.create_foreign_key('message_reactions_message_id_fkey', 'message_reactions', 'chat_messages', ['message_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('meetings_company_id_fkey', 'meetings', 'companies', ['company_id'], ['id'], ondelete='CASCADE')

    op.drop_constraint('meetings_organizer_id_fkey', 'meetings', type_='foreignkey')
    op.create_foreign_key('meetings_organizer_id_fkey', 'meetings', 'users', ['organizer_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('meeting_participants_meeting_id_fkey', 'meeting_participants', 'meetings', ['meeting_id'], ['id'], ondelete='CASCADE')

    op.drop_constraint('meeting_participants_user_id_fkey', 'meeting_participants', type_='foreignkey')
    op.create_foreign_key('meeting_participants_user_id_fkey', 'meeting_participants', 'users', ['user_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    # Meeting participants table FKs
    op.drop_constraint('meeting_participants_user_id_fkey', 'meeting_participants', type_='foreignkey')
    op.create_foreign_key('meeting_participants_user_id_fkey', 'meeting_participants', 'users', ['user_id'], ['id'])
    ...
    # Meetings table FKs
    op.drop_constraint('meetings_organizer_id_fkey', 'meetings', type_='foreignkey')
    op.create_foreign_key('meetings_organizer_id_fkey', 'meetings', 'users', ['organizer_id'], ['id'])

    op.drop_constraint('meetings_company_id_fkey', 'meetings', type_='foreignkey')
    op.create_foreign_key('meetings_company_id_fkey', 'meetings', 'companies', ['company_id'], ['id'])
    ...
    op.drop_constraint('message_reactions_message_id_fkey', 'message_reactions', type_='foreignkey')
    op.create_foreign_key('message_reactions_message_id_fkey', 'message_reactions', 'chat_messages', ['message_id'], ['id'])

    # Chat messages table FKs
    op.drop_constraint('chat_messages_channel_id_fkey', 'chat_messages', type_='foreignkey')
    op.create_foreign_key('chat_messages_channel_id_fkey', 'chat_messages', 'channels', ['channel_id'], ['id'])
    ...
    op.drop_constraint('chat_messages_company_id_fkey', 'chat_messages', type_='foreignkey')
    op.create_foreign_key('chat_messages_company_id_fkey', 'chat_messages', 'companies', ['company_id'], ['id'])
    ...
    # Channels table FKs
    op.drop_constraint('channels_created_by_fkey', 'channels', type_='foreignkey')
    op.create_foreign_key('channels_created_by_fkey', 'channels', 'users', ['created_by'], ['id'])
