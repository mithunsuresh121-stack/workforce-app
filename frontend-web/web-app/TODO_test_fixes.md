...
## Steps
- [x] Fix useWebSocketNotifications hook to properly connect WS after user loads
- [x] Update useWebSocketNotifications.test.tsx with proper auth mocks and act() wrapping
